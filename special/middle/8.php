				...
				<div class="flex__inner">
					<div class="flex__cart">
						<div class="flex__center__row">
							...
							<div class="flex__item">
								<div class="flex__center">
									<div class="flex__subtitle">Номер: 076</div>
						...
						<div class="flex__img">
							<img
								class="p-auto"
								src="../../img/addSpecialties/8/1.webp"
								alt="#"
							/>
							<img
								class="p-auto"
								src="../../img/addSpecialties/8/2.webp"
								alt="#"
							/>
							<img
								class="p-auto"
								src="../../img/addSpecialties/8/3.webp"
								alt="#"
							/>
						</div>
						<div class="flex__text">
							Під час навчання за даною освітньою програмою студенти отримують
							знання з організації комерційної та біржової діяльності, блокчейн
							технології, маркетингу послуг та інтернет маркетингу, реалізації
							цінової та асортиментної політики, електронної комерції, рекламної
							діяльності та SMM, ведення онлайн бізнесу, бренд-менеджменту та
							розробки інтернет стратегій просування. Випускники готові до
							роботи у торговельних, посередницьких, дистрибуційних,
							представницьких, консалтингових фірмах та організаціях, на
							вітчизняних та міжнародних біржах
						</div>
						<div class="flex__center mt-20">
							<a
								href="https://forms.gle/Qb4Q8YezWXa3BRjB7"
