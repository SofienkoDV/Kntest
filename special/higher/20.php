					...
					<div class="flex__cart">
						<div class="flex__center__row">
							<div class="flex__item">
								...
								<a href="http://erm.kntu.kr.ua/" target="_blank">
									<i class="fas fa-university"></i>
								</a>
								<a
									href="https://www.facebook.com/groups/1785338641788476"
									target="_blank"
								>
							...
							<div class="flex__item">
								<div class="flex__center">
									<div class="flex__subtitle">Номер: 274</div>
									<div class="flex__subtitle">Назва спеціальності:</div>
									<h1 class="flex__title">Автомобільний транспорт</h1>
								</div>
							</div>
						</div>
						<div class="flex__img">
							<img
								class="p-auto"
								src="../../img/addSpecialties/20/1.webp"
								alt="#"
							/>
							<img
								class="p-auto"
								src="../../img/addSpecialties/20/2.webp"
								alt="#"
							/>
							<img
								class="p-auto"
								src="../../img/addSpecialties/20/3.webp"
								alt="#"
							/>
						</div>
						<div class="flex__text">
							Магістри Спеціальність 274
						...
						<div class="flex__center mt-20">
							<a
								href="https://docs.google.com/forms/d/e/1FAIpQLSdH_EhxuNBsJdBYImVzLmuz0dy8IPY91bazBOkojUzmvGHOsg/viewform?usp=sf_link"
